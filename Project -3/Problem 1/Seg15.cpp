...

{
	...
	vector<vector<vector<double> > > Extended_Width2(SizeW,vector<vector<double> >((SizeL+14),vector<double>(9)));
	vector<vector<vector<double> > > Extended_Matrix2((SizeW+14),vector<vector<double> >((SizeL+14),vector<double>(9)));
